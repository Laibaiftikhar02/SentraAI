...
if not USER_PASSWORD:
    raise RuntimeError(
        "Seed password not found in environment. "
        "Ensure SEED_USER_PASSWORD is set in backend/.env"
    )
...
def main():
    """Run the Gemini LLM chatbot verification against the live backend."""
    # ── Login ──────────────────────────────────────────────────────────────────
    print("=" * 60)
...
def test_gemini_live():
    """pytest entry point for the Gemini LLM chatbot verification."""
    main()
